...
imageAlt: "Web development services in San Diego California"
population: "3.3M metro area"
timezone: "PST (Honduras CST +2 hours)"
keywords:
  - "web development San Diego"
  - "San Diego web development company"
  - "custom web development California"
  - "affordable web developers San Diego"
  - "nearshore web development San Diego"
  - "web development services San Diego"
...
faqs:
  ...
  - question: "What does a San Diego web project typically cost?"
    answer: "Our starting point is your budget, not a rate card. A Sorrento Valley biotech, a Gaslamp Quarter hospitality group with a booking flow, and a cross-border operation serving San Diego and Tijuana each need different resources, so you tell us the scope and the figure set aside, and we respond with a fixed-price proposal that itemizes what is included. From Honduras, that figure buys more senior engineering than a La Jolla or downtown agency would, and the code stays yours."
