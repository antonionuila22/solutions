...
imageAlt: "Web development services in Portland Oregon"
population: "2.5M metro area"
timezone: "PST (Honduras CST +2 hours)"
keywords:
  - "web development Portland"
  - "Portland web development company"
  - "custom web development Oregon"
  - "startup web developers Portland"
...
whyChooseUs:
  ...
  - title: "Design Execution Portland Respects"
    description: "We build pixel-perfect from Figma and treat aesthetics as functionality, not decoration. In a city where taste is a competitive advantage, we ship sites that look considered and load fast, with no templated shortcuts that a Portland audience spots instantly."
...
faqs:
  ...
  - question: "What does a Portland web project typically cost with your team?"
    answer: "Our pricing starts with your budget, not with a menu. A Portland apparel brand, a Silicon Forest manufacturer, or a bootstrapped startup tells us how much it can invest and what it needs delivered (an e-commerce storefront, a Figma-faithful marketing site, a web application, or senior developers on a specific stack), and we come back with a single fixed price attached to a scope that names every deliverable. Since the work is done in Honduras, that investment buys more senior engineering than a Pearl District agency can offer, and the repository is handed over to you at the end."
